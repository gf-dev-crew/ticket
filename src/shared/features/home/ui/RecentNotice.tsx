...
export default function RecentNotice() {
  ...
  /* 컴포넌트별 개별 에러 처리 (컴포넌트 내부에서 에러 처리) */
  if (error) {
    return (
  ...
  return (
    <section className='py-5xl px-xl border border-gray-200'>
      {/* 섹션 헤더 */}
      <div className='mb-4xl text-left'>
        <h2 className='font-jamsil-bold text-dark mb-lg text-4xl'>
          DB fetching test (HydrationBoundary)
        </h2>
      </div>
